    ...
    return (
        <div className='h-screen flex flex-col justify-between p-7'>
            <div>
                ...
                <p>New here? <Link to='/user-signup' className='text-blue-600 underline'>Create new Account</Link> </p>
            </div>
            <div>
                <Link to='/captain-login' className="bg-[#10b461] inline-flex w-full justify-center rounded px-4 py-2 text-white font-semibold mb-5 text-lg">Sign in as Captain
